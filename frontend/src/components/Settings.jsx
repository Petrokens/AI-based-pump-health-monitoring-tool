  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      try {
        ...
        if (mergedSettings.display?.theme) {
          if (mergedSettings.display.theme === 'auto') {
            const prefersDark = window.matchMedia('(prefers-color-scheme: dark)').matches;
            setTheme(prefersDark ? 'dark' : 'light');
          } else {
            setTheme(mergedSettings.display.theme);
          }
        }
      } catch (e) {
  ...
  return (
    <div className="bg-[var(--bg-primary)] min-h-screen p-6">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2 flex items-center">
        ...
        <div className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] mb-6">
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-2 px-6 py-4 border-b-2 transition-colors ${
                    activeTab === tab.id
                      ? 'border-primary-500 text-primary-400 bg-[var(--bg-secondary)]/50'
          ...
          <div className="p-6">
            ...
            {activeTab === 'alerts' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Critical Threshold (%)</label>
                      <input
                        type="number"
                        ...
                        max="100"
                      />
                      <p className="text-xs text-[var(--text-tertiary)] mt-1">Alerts when health index falls below this value</p>
                    </div>
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Warning Threshold (%)</label>
                      <input
                        type="number"
                        ...
                        max="100"
                      />
                      <p className="text-xs text-[var(--text-tertiary)] mt-1">Warnings when health index falls below this value</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Critical RUL (hours)</label>
                      <input
                        type="number"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Warning RUL (hours)</label>
                      <input
                        type="number"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Vibration Critical (mm/s)</label>
                      <input
                        type="number"
                        step="0.1"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Vibration Warning (mm/s)</label>
                      <input
                        type="number"
                        step="0.1"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Temperature Critical (°C)</label>
                      <input
                        type="number"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Temperature Warning (°C)</label>
                      <input
                        type="number"
            ...
            {activeTab === 'intervals' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Data Refresh Intervals (seconds)</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {Object.entries(settings.updateIntervals).map(([key, value]) => (
                      <div key={key} className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                        <label className="text-sm text-[var(--text-secondary)] mb-2 block capitalize">
                        ...
                        <input
                          ...
                          min="1"
                        />
                        <p className="text-xs text-[var(--text-tertiary)] mt-1">Update every {value} seconds</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {activeTab === 'display' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Display Options</h3>
                  <div className="space-y-4">
                    {Object.entries(settings.display).map(([key, value]) => (
                      <div key={key} className="bg-[var(--bg-secondary)]/50 rounded-lg p-4 flex items-center justify-between">
                        <div>
                          <label className="text-sm font-medium text-[var(--text-primary)] block capitalize">
                            {key.replace(/([A-Z])/g, ' $1').trim()}
                          </label>
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4 flex items-center justify-between">
                      <div>
                        <label className="text-sm font-medium text-[var(--text-primary)] block">Enable Email Notifications</label>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Receive alerts via email</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4 flex items-center justify-between">
                      <div>
                        <label className="text-sm font-medium text-[var(--text-primary)] block">Enable Sound Alerts</label>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Play sound for critical alerts</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4 flex items-center justify-between">
                      <div>
                        <label className="text-sm font-medium text-[var(--text-primary)] block">Critical Alerts Only</label>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Only notify for critical issues</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
            ...
            {activeTab === 'data' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                    <label className="text-sm text-[var(--text-secondary)] mb-2 block">Retention Period (days)</label>
                    <input
                      type="number"
                      ...
                      max="365"
                    />
                    <p className="text-xs text-[var(--text-tertiary)] mt-1">Keep data for {settings.data.retentionDays} days</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Export Format</label>
                      <select
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4 flex items-center justify-between">
                      <div>
                        <label className="text-sm font-medium text-[var(--text-primary)] block">Auto Export</label>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Automatically export data daily</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Max Data Points per Chart</label>
                      <input
                        type="number"
            ...
            {activeTab === 'api' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Base URL</label>
                      <input
                        type="text"
                    ...
                    <div className="bg-[var(--bg-secondary)]/50 rounded-lg p-4">
                      <label className="text-sm text-[var(--text-secondary)] mb-2 block">Retry Attempts</label>
                      <input
                        type="number"
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-between bg-[var(--bg-card)] rounded-xl p-6 border border-[var(--border-color)]">
          <button
            onClick={handleReset}
            className="flex items-center space-x-2 px-4 py-2 bg-[var(--bg-secondary)] hover:bg-[var(--bg-card-hover)] text-[var(--text-primary)] rounded-lg transition-colors"
          >
